...
Title Building TVServer Kodi (RELEASE)
CD ..
...
"Tools\Tools\sed.exe" -i -r "s/(Assembly(File)?Version\(.[0-9]+\.[0-9]+\.[0-9]+\.)[0-9]+(.\))/\1%REVISION%\3/g" "TVServerKodi\Properties\AssemblyInfo.cs"

:: Build
"%MSBUILD_PATH%" /target:Rebuild /property:Configuration=RELEASE /fl /flp:logfile=TVServerKodi.log;verbosity=diagnostic TVServerKodi\TVServerKodi.sln

:: Revert version
git checkout "TVServerKodi\Properties\AssemblyInfo.cs"
